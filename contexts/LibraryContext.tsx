...
// Провайдер может быть временно недоступен во время горячего обновления HMR, вернитесь к безопасному значению по умолчанию, чтобы избежать сбоев
...
export const useLibrary = () => {
  ...
  if (!context) {
    console.warn('[useLibrary] Provider Не готов, вернитесь к значению по умолчанию (выполняется горячее обновление HMR)');
